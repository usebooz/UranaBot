...
export type GetLeagueQuery = { __typename?: 'Query', fantasyQueries: { __typename?: 'FantasyQueries', league?: { __typename?: 'FantasyLeague', id: string, name: string, totalSquadsCount: number, season: { __typename?: 'FantasySeason', id: string, isActive: boolean, tournament: { __typename?: 'FantasyTournament', id: string, webName: string }, tours: Array<{ __typename?: 'FantasyTour', id: string, status: FantasyTourStatus }> } } | null } };
